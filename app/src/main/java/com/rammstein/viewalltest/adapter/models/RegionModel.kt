...
/**
 * Created by klitaviy on 1/12/18-3:57 PM.
 */
class RegionModel(listener: (ExpandableAdapterModel) -> Unit) : ExpandableAdapterModel(listener)  {

    override fun createNewHolder() = RegionHolder()
    ...
    inner class RegionHolder : ViewAllAdapterEpoxyHolder() {
