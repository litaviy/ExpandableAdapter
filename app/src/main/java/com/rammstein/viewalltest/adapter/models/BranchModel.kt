...
/**
 * Created by klitaviy on 1/12/18-5:07 PM.
 */
class BranchModel(private val listener: (ExpandableAdapterModel) -> Unit) : ExpandableAdapterModel(listener) {

    override fun createNewHolder() = BranchHolder()
    ...
    inner class BranchHolder : ViewAllAdapterEpoxyHolder() {
